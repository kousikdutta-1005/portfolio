...
import { BuildGates } from "@/components/BuildGates"
...
const RETRO: CaseRetroItem[] = [
  ...
  },
  {
    ...
    shipped:
      "The build ran TypeScript, a Vite build, a sitemap step, and a custom glass check. It had no accessibility gate at all, so a contrast failure or a link below the 24 pixel target size could ship, and did, while every check stayed green. Linting sat outside the build in a separate script I had to remember to run, which is the same as not having it.",
    better:
      ...
      <div className="portfolio-case-study relative" style={{ overflowX: "clip" }}>
        ...
        <section className="py-10 md:py-14" id="craft">
          <div className="max-w-[980px] mx-auto px-6 md:px-10">
            ...
            <motion.h3 className="mt-10 text-[22px] font-bold tracking-tight mb-2" variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              How I check the work
            </motion.h3>
            <motion.p className="text-[15px] text-muted-foreground mb-5 max-w-[700px]" variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              Three checks run on every build and fail it outright. They are not advisory, and this section is generated by them rather than written about them.
            </motion.p>
            <BuildGates />
            <div className="mt-8">
              <PortfolioImageFigure
